...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_drive_dir", type=str, help="Base drive directory to store results",
                        default="/home/ubuntu/")
    parser.add_argument("--shard_size", type=int, help="Shard size to use for inference", default=2048)
    ...
    parser.add_argument("--num_of_results", type=int, help="Number of results to generate", default=5)
    parser.add_argument("--num_of_few_shot", type=int, help="Number of few shot examples to use", default=5)
